...
public class Main extends Application {
    ...
    private Image image= new Image("gameOver.jpg", 1280, 720, true, true);
    private ImageView onDeath= new ImageView(image);

    private Image image1= new Image("wonGame.jpeg", 1280, 720, true, true);
    private ImageView onWin= new ImageView(image1);

    private Image image2= new Image("help.jpg", 1280, 720, true, true);
    ...
    private void initContent() throws IOException{
        ...
        Image image1 = new Image("forest.jpg", 1280, 720, true, true);
